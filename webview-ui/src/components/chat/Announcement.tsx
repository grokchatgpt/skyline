...
/*
You must update the latestAnnouncementId in skylineProvider for new announcements to show to users. This new id will be compared with what's in state for the 'last announcement shown', and if it's different then the announcement will render. As soon as an announcement is shown, the id will be updated in state. This ensures that announcements are not shown more than once, even if the user doesn't close it themselves.
*/
	...
	return (
		<div style={containerStyle}>
			...
			<Accordion isCompact className="pl-0">
				<AccordionItem
					...
					<ul style={ulStyle}>
						...
						<li>
							<b>UX Improvements:</b> Type while skyline works, smarter auto-scrolling, and copy buttons for task
						...
						<li>
							<b>Global skyline Rules:</b> Store multiple rules files in Documents/skyline/Rules to share between
							projects.
						</li>
					</ul>
				</AccordionItem>
			...
			<p style={linkContainerStyle}>
				Join us on{" "}
				<VSCodeLink style={linkStyle} href="https://x.com/skyline">
					X,
				</VSCodeLink>{" "}
				<VSCodeLink style={linkStyle} href="https://discord.gg/skyline">
					discord,
				</VSCodeLink>{" "}
				or{" "}
				<VSCodeLink style={linkStyle} href="https://www.reddit.com/r/skyline/">
					r/skyline
				</VSCodeLink>
				for more updates!
			</p>
