...
// Featured models for skyline provider
...
const OpenRouterModelPicker: React.FC<OpenRouterModelPickerProps> = ({ isPopup }) => {
	...
	const modelIds = useMemo(() => {
		...
		return apiConfiguration?.apiProvider === "skyline"
	...
	return (
		<div style={{ width: "100%" }}>
			...
			<div style={{ display: "flex", flexDirection: "column" }}>
				...
				{apiConfiguration?.apiProvider === "skyline" && (
			...
			{hasInfo ? (
				...
				<p
					...
					<>
						...
						If you're unsure which model to choose, skyline works best with{" "}
						<VSCodeLink
