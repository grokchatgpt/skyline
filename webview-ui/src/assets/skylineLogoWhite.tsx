...
const skylineLogoWhite = (props: SVGProps<SVGSVGElement>) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="47" height="50" viewBox="0 0 1218 1040" fill="white" {...props}>
		<path
...
export default skylineLogoWhite
