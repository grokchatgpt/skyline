...
import { skylineAPI } from "./skyline"
import { getGlobalState } from "@core/storage/state"

export function createskylineAPI(outputChannel: vscode.OutputChannel, sidebarController: Controller): skylineAPI {
	const api: skylineAPI = {
