...
/**
 * Combines API request start and finish messages in an array of skylineMessages.
 *
 ...
 * @returns A new array of skylineMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: skylineMessage[]): skylineMessage[] {
	const combinedApiRequests: skylineMessage[] = []
