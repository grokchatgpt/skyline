import { skylineMessage } from "./ExtensionMessage"

/**
 * Combines sequences of command and command_output messages in an array of skylineMessages.
 *
 * This function processes an array of skylineMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of skylineMessage objects to process.
 * @returns A new array of skylineMessage objects with command sequences combined.
 *
 * @example
 * const messages: skylineMessage[] = [
 ...
 */
export function combineCommandSequences(messages: skylineMessage[]): skylineMessage[] {
	const combinedCommands: skylineMessage[] = []
