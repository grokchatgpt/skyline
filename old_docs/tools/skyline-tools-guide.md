# skyline Tools Reference Guide

## What Can skyline Do?

skyline is your AI assistant that can:
...
3. **Review Changes**
    - skyline will show diffs before making changes
...
For the most up-to-date implementation details, you can view the full source code in the [skyline repository](https://github.com/skyline/skyline/blob/main/src/core/task/index.ts).

skyline has access to the following tools for various tasks:
...
3. **MCP Tools**
    ...
    - Users can create custom MCP tools that skyline can then access
    - Example: Create a weather API tool that skyline can use to fetch forecasts
...
-   [Join the Discord community](https://discord.gg/skyline)
-   Check the documentation
-   Provide feedback to improve skyline
