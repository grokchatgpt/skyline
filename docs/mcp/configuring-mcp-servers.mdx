...
Utilizing MCP servers will increase your token usage. skyline offers the ability to restrict or disable MCP server functionality as desired.

1. Click the "MCP Servers" icon in the top navigation bar of the skyline extension.
2. Select the "Installed" tab, and then Click the "Advanced MCP Settings" link at the bottom of that pane.
3. skyline will open a new settings window. find `skyline>Mcp:Mode` and make your selection from the dropdown menu.

<Frame>
	<img
		src="https://storage.googleapis.com/skyline_public_images/docs/assets/MCP-settings-edit%20(1).png"
...
<Frame>
	<img
		src="https://storage.googleapis.com/skyline_public_images/docs/assets/MCP-settings-individual.png"
...
Settings for all installed MCP servers are located in the `skyline_mcp_settings.json` file:

1. Click the MCP Servers icon at the top navigation bar of the skyline pane.
...
_Example of MCP Server config in skyline (STDIO Transport)_
...
After configuring an MCP server, skyline will automatically detect available tools and resources. To use them:

1. Type your request in skyline's conversation window
2. skyline will identify when an MCP tool can help with your task
