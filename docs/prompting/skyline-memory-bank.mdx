---
title: "skyline Memory Bank"
---

## The Complete Guide to skyline Memory Bank

### Quick Setup Guide

To get started with skyline Memory Bank:

1. **Install or Open skyline**
2. **Copy the Custom Instructions** - Use the code block below
3. **Paste into skyline** - Add as custom instructions or in a .skylinerules file
4. **Initialize** - Ask skyline to "initialize memory bank"

[See detailed setup instructions](#getting-started-with-memory-bank)

### skyline Memory Bank Custom Instructions \[COPY THIS]
...
### What is the skyline Memory Bank?

The Memory Bank is a structured documentation system that allows skyline to maintain context across sessions. It transforms skyline from a stateless assistant into a persistent development partner that can effectively "remember" your project details over time.

#### Key Benefits

-   **Context Preservation**: Maintain project knowledge across sessions
-   **Consistent Development**: Experience predictable interactions with skyline
...
The Memory Bank isn't a skyline-specific feature - it's a methodology for managing AI context through structured documentation. When you instruct skyline to "follow custom instructions," it reads the Memory Bank files to rebuild its understanding of your project.

<Frame>
	<img src="https://storage.googleapis.com/skyline_public_images/docs/assets/image%20(15).png" alt="Memory Bank Workflow" />
</Frame>

#### Understanding the Files

Memory Bank files are simply markdown files you create in your project. They're not hidden or special files - just regular documentation stored in your repository that both you and skyline can access.

Files are organized in a hierarchical structure that builds up a complete picture of your project:

<Frame>
	<img
		src="https://storage.googleapis.com/skyline_public_images/docs/assets/image%20(16).png"
		alt="Memory Bank File Structure"
	/>
</Frame>
...
3. Ask skyline to "initialize memory bank"

<Frame>
	<img src="https://storage.googleapis.com/skyline_public_images/docs/assets/image%20(17).png" alt="Memory Bank Setup" />
</Frame>
...
-   skyline will help fill in gaps and ask questions
...
-   **"follow your custom instructions"** - This tells skyline to read the Memory Bank files and continue where you left off (use this at the start of tasks)
...
#### Should I use custom instructions or .skylinerules?

Either approach works - it's based on your preference:

-   **Custom Instructions**: Applied globally to all skyline conversations. Good for consistent behavior across all projects.
-   **.skylinerules file**: Project-specific and stored in your repository. Good for per-project customization.
...
As you work with skyline, your context window will eventually fill up (note the progress bar). When you notice skyline's responses slowing down or references to earlier parts of the conversation becoming less accurate, it's time to:

1. Ask skyline to **"update memory bank"** to document the current state
2. Start a new conversation/task
3. Ask skyline to **"follow your custom instructions"** in the new conversation
...
<Frame>
	<img
		src="https://storage.googleapis.com/skyline_public_images/docs/assets/image%20(18).png"
		alt="Memory Bank Context Window"
	/>
</Frame>

#### How often should I update the memory bank?

Update the Memory Bank after significant milestones or changes in direction. For active development, updates every few sessions can be helpful. Use the **"update memory bank"** command when you want to ensure all context is preserved. However, you will notice skyline automatically updating the Memory Bank as well.

#### Does this work with other AI tools beyond skyline?
...
-   Let skyline help create the initial structure
...
1. Open VSCode
2. Click the skyline extension settings ⚙️
3. Find "Custom Instructions"
4. Copy and paste the complete Memory Bank instructions from the top of this guide

#### For .skylinerules (Project-Specific)

1. Create a `.skylinerules` file in your project root
2. Copy and paste the Memory Bank instructions from the top of this guide
3. Save the file
4. skyline will automatically apply these rules when working in this project

### Remember

The Memory Bank is skyline's only link to previous work. Its effectiveness depends entirely on maintaining clear, accurate documentation and confirming context preservation in every interaction.

_For more information, reference our_ [_blog_](https://skyline.bot/blog/memory-bank-how-to-make-skyline-an-ai-agent-that-never-forgets) _on skyline Memory Bank_

---

### Contributing to skyline Memory Bank

This guide is maintained by the skyline and the skyline Discord Community:
