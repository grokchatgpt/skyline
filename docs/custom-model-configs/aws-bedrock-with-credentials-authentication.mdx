---
title: "AWS Bedrock"
description: "Learn how to set up AWS Bedrock with skyline using credentials authentication. This guide covers AWS environment setup, regional access verification, and secure integration with the skyline VS Code extension."
---
...
-   **skyline:** A VS Code extension that acts as a coding assistant by integrating with AI models—empowering developers to generate code, debug, and analyze data.
...
2. **Install the skyline Extension:**
    - Open VS Code.
    - Go to the Extensions Marketplace (`Ctrl+Shift+X` or `Cmd+Shift+X`).
    - Search for **skyline** and install it.

#### 3.2 Configure skyline Settings

1. **Open skyline Settings:**
...
By following these steps, your enterprise team can securely integrate AWS Bedrock with the skyline VS Code extension to accelerate development:
...
3. **Configure skyline in VS Code:** Install and set up skyline with your AWS credentials and choose an appropriate model.
...
_This guide will be updated as AWS Bedrock and skyline evolve. Always refer to the latest documentation and internal policies for up-to-date practices._
