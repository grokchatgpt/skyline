---
title: "GCP Vertex AI"
description: "Configure GCP Vertex AI with skyline to access leading generative AI models like Claude 3.5 Sonnet v2. This guide covers GCP environment setup, authentication, and secure integration for enterprise teams."
---
...
### Step 3: Configure the skyline VS Code Extension

#### 3.1 Install and Open skyline

-   **Download VS Code:**\
    [Download Visual Studio Code](https://code.visualstudio.com/)
-   **Install the skyline Extension:**
    -   Open VS Code
    -   Navigate to the Extensions Marketplace (Ctrl+Shift+X or Cmd+Shift+X)
    -   Search for **skyline** and install the extension

<Frame>
	<img
		src="https://storage.googleapis.com/skyline_public_images/docs/assets/skyline-extension-arrow.png"
		alt="skyline extension in VS Code"
	/>
</Frame>

#### 3.2 Configure skyline Settings

-   **Open skyline Settings:**\
    Click the settings ⚙️ icon within the skyline extension
-   **Set API Provider:**\
...
3. **Restart VS Code:**\
   Ensure VS Code is restarted so that the skyline extension picks up the new credentials
...
4. **Set the Environment Variable:**
    ...
    - This instructs Google Cloud client libraries (and skyline) to use this key
...
By following these steps, your enterprise team can securely integrate GCP Vertex AI with the skyline VS Code extension to harness the power of **Claude 3.5 Sonnet v2**:
...
-   **Configure skyline in VS Code:**\
    Install skyline, enter your project ID, select the appropriate region, and choose the model
...
_This guide will be updated as GCP Vertex AI and skyline evolve. Always refer to the latest documentation for current practices._
