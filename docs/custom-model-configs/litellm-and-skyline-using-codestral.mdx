---
title: "LiteLLM & skyline (using Codestral)"
description: "Learn how to set up and run LiteLLM with skyline using the Codestral model. This guide covers Docker setup, configuration, and integration with skyline."
---

### Using LiteLLM with skyline

This guide demonstrates how to run a demo for LiteLLM starting with the Codestral model for use with skyline.
...
2. **Setup skyline**
    ...
    Once the LiteLLM server is up and running you can set it up in skyline:
...
-   [skyline Discord Community](https://discord.gg/skyline)
