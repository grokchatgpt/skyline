...
Plan & Act modes represent skyline's approach to structured AI development, emphasizing thoughtful planning before implementation. This dual-mode system helps developers create more maintainable, accurate code while reducing iteration time.

<Frame>
	<img
		src="https://storage.googleapis.com/skyline_public_images/docs/assets/planningThenActing%20(1).gif"
...
-   Has access to all of skyline's building capabilities
-   Maintains context from the planning phase
-   Can execute changes to your codebase

<Frame>
	<img src="https://storage.googleapis.com/skyline_public_images/docs/assets/image%20(5).png" alt="Act mode capabilities" />
</Frame>
...
<Frame>
	<img src="https://storage.googleapis.com/skyline_public_images/docs/assets/image%20(5)%20(1).png" alt="Plan mode workflow" />
</Frame>

-   Share your requirements
-   Let skyline analyze relevant files
-   Engage in dialogue to clarify objectives
-   Develop implementation strategy

<Frame>
	<img
		src="https://storage.googleapis.com/skyline_public_images/docs/assets/image%20(2)%20(1)%20(1)%20(1).png"
		alt="Planning phase"
	/>
</Frame>
...
<Frame>
	<img
		src="https://storage.googleapis.com/skyline_public_images/docs/assets/switching-to-act.gif"
		alt="Switching to Act mode"
	/>
</Frame>

Act mode allows skyline to:
...
3. Point skyline to relevant files if he hasn't read them
...
<Frame>
	<img
		src="https://storage.googleapis.com/skyline_public_images/docs/assets/image%20(3)%20(1).png"
...
-   Have skyline write markdown files of the plan for future reference
...
<Frame>
	<img src="https://storage.googleapis.com/skyline_public_images/docs/assets/image%20(6).png" alt="Mode usage patterns" />
</Frame>
...
-   Join our [Discord community](https://discord.gg/skyline)
