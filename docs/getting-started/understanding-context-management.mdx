...
description: "Context is key to getting the most out of skyline"
---

> 💡 **Quick Reference**
>
> -   Context = The information skyline knows about your project
> -   Context Window = How much information skyline can hold at once
...
<Frame caption="In a world of infinite context, the context window is what skyline currently has available">
	<img
		src="https://storage.googleapis.com/skyline_public_images/docs/assets/image%20(2).png"
		alt="In a world of infinite context, the context window is what skyline currently has available"
	/>
</Frame>

Think of working with skyline like collaborating with a thorough, proactive teammate:

### How Context is Built

skyline actively builds context in two ways:

1. **Automatic Context Gathering (i.e. skyline-driven)**
...
2. **User-Guided Context**
    ...
    - Answer skyline's questions
    - Guide focus areas
    - Share design thoughts and requirements

💡 **Key Point**: skyline isn't passive - it actively seeks to understand your project. You can either let it explore or guide its focus, especially in [Plan](https://docs.skyline.bot/exploring-skylines-tools/plan-and-act-modes-a-guide-to-effective-ai-development) mode.

### Context & Context Windows

Think of context like a whiteboard you and skyline share:

-   **Context** is all the information available:
    -   What skyline has discovered
    -   What you've shared
...
-   **Context Window** is the size of the whiteboard itself:
    ...
    -   When the whiteboard is full, you need to erase (clear context) to write more
        -   [How skyline manages context under the hood](https://skyline.bot/blog/understanding-the-new-context-window-progress-bar-in-skyline)
...
skyline provides a visual way to monitor your context window usage through a progress bar:

<Frame caption="Visual representation of the context window usage">
	<img
		src="https://storage.googleapis.com/skyline_public_images/docs/assets/image%20(1)%20(1).png"
...
-   When skyline seems to lose context
...
1. **Evergreen Project Context (i.e.** [**Memory Bank**](https://docs.skyline.bot/improving-your-prompting-skills/custom-instructions-library/skyline-memory-bank)**)**
...
2. **Task-Specific Context (i.e.** [**Structured Approach**](https://skyline.bot/blog/building-advanced-software-with-skyline-a-structured-approach)**)**
...
3. **Knowledge Transfer Docs**
    - Switch to plan mode and ask skyline to document everything you've accomplished so far, along with the remaining steps, in a markdown file.
...
1. **Starting New Projects**
    - Let skyline explore the codebase
...
3. **Team Projects**
    - Share common context files (consider using [.skylinerules](https://docs.skyline.bot/improving-your-prompting-skills/prompting) files in project roots)
    - Document architectural decisions
    - Maintain consistent patterns
    - Keep documentation current

Remember: The goal is to help skyline maintain consistent understanding of your project across sessions.
