...
description: "A curated list of our recommended technologies and tools for building modern web applications with skyline."
---

## Recommended Stack for New skyline Users (2025)
...
1. Install the development essentials:
    - Follow our [Development Essentials Installation Guide](https://docs.skyline.bot/getting-started/getting-started-new-coders/installing-dev-essentials)
2. Set up skyline's Memory Bank:
    - Follow the [Memory Bank setup instructions](https://docs.skyline.bot/improving-your-prompting-skills/custom-instructions-library/skyline-memory-bank)
    - Create an empty `skyline_docs` folder in your project root
    - Create `projectBrief.md` in the `skyline_docs` folder (see example below)
    - Tell skyline to "initialize memory bank"
3. Add our recommended stack configuration:
    - Create `.skylinerules` file (see template below)
    - Let skyline handle the rest!
...
-   Be reviewed by skyline before execution
    Example: 001_create_users_table.sql

## Development Workflow

-   skyline helps write and review code changes
-   Vercel automatically deploys from main branch
-   Database migrations reviewed by skyline before execution
...
1. Use `/help` in skyline chat for immediate assistance
2. Check [skyline Documentation](https://docs.skyline.bot)
3. Join our [Discord Community](https://discord.gg/skyline)
4. Search GitHub issues for common problems

Remember: skyline is here to help at every step. Just ask for guidance or clarification when needed!
