---
title: "Task Management in skyline"
description: "Learn how to effectively manage your task history, use favorites, and organize your work in skyline."
---

# Task Management

As you use skyline, you'll accumulate many tasks over time. The task management system helps you organize, filter, search, and clean up your task history to keep your workspace efficient.

## Accessing Task History

You can access your task history by:

1. Clicking on the "History" button in the skyline sidebar
2. Using the command palette to search for "skyline: Show Task History"
...
-   **Open**: Click on a task to reopen it in the skyline chat
...
Task management helps you maintain an organized workflow when using skyline, allowing you to quickly find past conversations, preserve important work, and keep your history clean and efficient.
