...
description: "Welcome to skyline, your AI-powered coding companion! This guide will help you quickly set up your development environment and begin your coding journey with ease."
---

> 💡 **Tip:** If you're completely new to coding, take your time with each step. There's no rush — skyline is here to guide you!
...
👉 Follow our detailed guide on Installing Essential Development Tools with step-by-step help from skyline.
...
Create a dedicated folder named `skyline` in your Documents folder for all your coding projects:

-   **macOS:** `/Users/[your-username]/Documents/skyline`
-   **Windows:** `C:\Users\[your-username]\Documents\skyline`

Inside your `skyline` folder, structure projects clearly:

-   `Documents/skyline/workout-app` _(e.g., for a fitness tracking app)_
-   `Documents/skyline/portfolio-website` _(e.g., to showcase your work)_

> 💡 **Tip:** Keeping your projects organized from the start will save you time and confusion later!

#### 4. **Install the skyline VS Code Extension**

Enhance your coding workflow by installing the skyline extension directly within VS Code:

-   Get Started with skyline Extension Tutorial
...
🎉 You're all set! Dive in and start coding smarter and faster with **skyline**.
